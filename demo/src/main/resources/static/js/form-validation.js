...
function checkBirthday() {
    ...
    if (!birthday) {
        document
            ...
            .setCustomValidity("誕生日を入力してください");
        document.getElementById("birthdayInvalidFeedback").innerHTML =
            "誕生日を入力してください";
        return;
    }
    ...
    if (!birthday.match(validDateRegex)) {
        document
            .getElementById("birthday")
            .setCustomValidity("yyyy/MM/ddの形式で入力してください");
        document.getElementById("birthdayInvalidFeedback").innerHTML =
...
function checkAge() {
    ...
    if (age < 20 || age > 100) {
        document
            .getElementById("age")
            .setCustomValidity("20以上100以下の数値にしてください");
        document.getElementById("ageInvalidFeedback").innerHTML =
            "20以上100以下の数値にしてください";
    } else {
